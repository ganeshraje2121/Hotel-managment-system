...
class Login_Window:
    def __init__(self,root):
        ...
        self.bg= ImageTk.PhotoImage(file=r"C:\Users\lenovo\Downloads\HOTEL MANAGEMENT SYSTEM\images\login back.jpg")  # path for image
        ...
        img1=Image.open(r"C:\Users\lenovo\Downloads\HOTEL MANAGEMENT SYSTEM\images\login logo.png")      #path for image
        ...
        # icon images
        img2 = Image.open(r"C:\Users\lenovo\Downloads\HOTEL MANAGEMENT SYSTEM\images\user.png")  # path for image
        img2 = img2.resize((25, 25), Image.ANTIALIAS)
        self.photoimage2 = ImageTk.PhotoImage(img2)
        lblimg1 = Label(image=self.photoimage2, bg="black", borderwidth=0)
        lblimg1.place(x=650, y=323, width=25, height=25)

        img3 = Image.open(r"C:\Users\lenovo\Downloads\HOTEL MANAGEMENT SYSTEM\images\pass.png")  # path for image
...
class Register:
    def __init__(self,root):
        ...
        # ======= bg image ===========
        self.bg= ImageTk.PhotoImage(file=r"C:\Users\lenovo\Downloads\HOTEL MANAGEMENT SYSTEM\images\hotel_logo.png")  # path for image
        bg_lbl=Label(self.root,image=self.bg)
        bg_lbl.place(x=0,y=0,relwidth=1,relheight=1)


         # ======= bg image ===========
        self.bg1= ImageTk.PhotoImage(file=r"C:\Users\lenovo\Downloads\HOTEL MANAGEMENT SYSTEM\images\hotel_logo.png")  # path for image
        ...
        #btns
        img=Image.open(r"C:\Users\lenovo\Downloads\HOTEL MANAGEMENT SYSTEM\images\hotel_logo.png")
        ...
        img1=Image.open(r"C:\Users\lenovo\Downloads\HOTEL MANAGEMENT SYSTEM\images\hotel_logo.png")
