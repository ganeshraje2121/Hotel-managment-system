...
class Cust_Win:
    def __init__(self,root):
        ...
        txtcname.grid(row=1,column=1)
         ...
         # ===============mother name =======
        lblmname=Label(lableframeleft,font=("arial",12,"bold"),text="Mother Name:",padx=2,pady=6)
        lblmname.grid(row=2,column=0,sticky=W)
        txtmname=ttk.Entry(lableframeleft,textvariable=self.var_mother,font=("arial",13,"bold"),width=29)
        ...
        combo_id["value"]=("Adhar","Driving License","Passport")
        combo_id.current(0)
