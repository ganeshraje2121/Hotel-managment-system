...
class Roombooking:
    def __init__(self,root):
        ...
        # No of Days
        lblNoOfDays=Label(labelframeleft,font=("arial",12,"bold"),text="Number Of Days:",padx=2,pady=6)
        ...
        # Total Cost
        lblIdNumber=Label(labelframeleft,font=("arial",12,"bold"),text="Available Room:",padx=2,pady=6)
        ...
        img3=Image.open(r"C:\Users\lenovo\Downloads\HOTEL MANAGEMENT SYSTEM\images\myhotel.jpg")
        img3=img3.resize((550,300),Image.ANTIALIAS)
        self.photoimg3=ImageTk.PhotoImage(img3)
        lbing=Label(self.root,image=self.photoimg3,bd=0,relief=RIDGE)
        lbing.place(x=760,y=55,width=520,height=200)
